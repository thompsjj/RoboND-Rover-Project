...
def rover_coords(binary_img):
    ...
    ypos = binary_img.nonzero()[0]
    xpos = binary_img.nonzero()[1]
...
def warp_image_to_perspective(image, dst_size=5, 
                              bottom_offset=6, 
...
def update_memory(Rover, world_size=200):
    #print(Rover.pos[0])
    #print(Rover.pos[1])
    ...
    #print(rover_x)
    #print(rover_y)
    Rover.memorymap[rover_y, rover_x, 0] = 1

# Apply the above functions in succession and update the Rover state accordingly
def perception_step(Rover):

    # 0: obstacle, 1: rock, 2: terrain

    warped, mask = warp_image_to_perspective(Rover.img)
